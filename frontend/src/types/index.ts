...
export interface UserAffiliateDetail {
  ...
  /** Refund clawback still owed after transferred balance was already spent/reserved. */
  aff_debt: number
  aff_debt_micros?: number
...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'codex' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'codex' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek'
