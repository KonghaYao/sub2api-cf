export default {
    ...
    groups: {
      ...
      groupModels: {
        ...
        empty: 'No models are configured; sync them from accounts in this group',
        syncAccounts: 'Sync from group accounts',
        syncHint: 'Syncs model mappings confirmed on group accounts. New models remain pending pricing; prices are never guessed.',
        syncSuccess: 'Sync complete: {synchronized} models in the resulting set, {pending_price} pending pricing',
        syncFailed: 'Failed to sync group account models',
        pendingPrice: 'Pending pricing',
        setPrice: 'Set price',
        updatePrice: 'Update price',
        pricingTitle: 'Model pricing (USD)',
        inputPrice: 'Input price ($/million tokens)',
        outputPrice: 'Output price ($/million tokens)',
        cacheReadPrice: 'Cache read price ($/million tokens)',
        perRequestPrice: 'Per-request price ($/request)',
        minimumReservation: 'Minimum reservation ($/request)',
        priceHint: 'Up to 6 decimal places. Publishing a new price preserves the previous version in history.',
        publishPrice: 'Publish price',
        invalidPrice: 'Prices must be valid non-negative amounts with at most 6 decimal places',
        priceSuccess: 'Model price published',
        priceFailed: 'Failed to publish model price',
        enabled: 'Enabled',
        disabled: 'Disabled',
        disable: 'Disable',
        restore: 'Restore',
