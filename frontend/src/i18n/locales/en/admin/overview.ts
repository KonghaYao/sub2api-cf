export default {
    ...
    groups: {
      ...
      groupModels: {
        ...
        addModel: 'Add model',
        selectModel: 'Select an unlinked model',
        add: 'Add',
        addSuccess: 'Model added to the group',
        addFailed: 'Failed to add model to the group',
        configuredEnabled: 'Enabled',
        configuredDisabled: 'Disabled',
        remove: 'Disable',
        restore: 'Restore',
        removeSuccess: 'Model disabled for this group',
        removeFailed: 'Failed to disable group model',
        restoreSuccess: 'Group model restored',
        restoreFailed: 'Failed to restore group model',
        restoreGlobalDisabled: 'The global model is disabled and cannot be restored',
        restoreUnavailable: 'The model is not currently available for restoration. Refresh and try again.',
        catalogCompatibilityTitle: 'API model list display and order (compatibility)',
        catalogCompatibilityHint: 'Only filters and orders models that are already routable. It does not create models, enable account capabilities, or publish prices. Red entries will not appear in /v1/models.',
        catalogCompatibilityEnabled: 'Enable compatibility display filtering and ordering',
        catalogInvalid: 'Currently not routable',
        catalogSaved: 'API model list display settings saved',
        catalogSaveFailed: 'Failed to save API model list display settings',
        routingHint: 'The model also needs an eligible account capability and active pricing before it appears in the gateway model list.',
        ...
        diagnosis: { routable: 'Routable', blocked: 'Blocked', reasons: { group_model_missing: 'Model is not linked', group_disabled: 'Group is disabled', global_model_disabled: 'Global model is disabled', group_model_disabled: 'Group model is disabled', catalog_hidden: 'Hidden from catalog', platform_mismatch: 'Group and model platforms do not match', active_price_missing: 'No active price', no_group_account: 'Group has no account', no_healthy_capable_account: 'No healthy schedulable account with matching capability' } }
      },
      sortOrder: 'Sort',
      columnSettings: 'Column Settings',
