export default {
    ...
    invitation: {
      ...
      description: 'Create and control invitation-only registration codes',
      create: 'Create Invitation Code',
      edit: 'Edit Invitation Code',
      ...
      autoGenerate: 'Leave empty to generate automatically',
      copyLink: 'Copy register link',
      records: 'Usage records',
      usageRecords: 'Invitation usage records',
      noUsages: 'No usage records yet',
      empty: 'No invitation codes found',
      deleteConfirm: 'Delete this unused invitation code? This action cannot be undone.',
      created: 'Invitation code created',
      updated: 'Invitation code updated',
      deleted: 'Invitation code deleted',
      linkCopied: 'Registration link copied',
      failedToLoad: 'Failed to load invitation codes',
      failedToCreate: 'Failed to create invitation code',
      failedToUpdate: 'Failed to update invitation code',
      failedToDelete: 'Failed to delete invitation code',
      failedToLoadUsages: 'Failed to load invitation usage records',
      failedToCopy: 'Failed to copy registration link'
    },
