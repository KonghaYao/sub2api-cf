export default {
    settings: {
      ...
      security: {
        ...
        passkeyDeploymentHint: 'Set WEBAUTHN_RP_ID (domain only), WEBAUTHN_RP_ORIGINS (full HTTPS origins), and optionally WEBAUTHN_RP_NAME in the Worker deployment variables, then redeploy.',
