export default {
    ...
    channels: {
      ...
      form: {
        ...
        accountStatsRuleScopeRequired: 'Select at least one group or account for every account-stat pricing rule',
        accountStatsRulePricingRequired: 'Every account-stat pricing rule needs at least one model price',
        accountStatsRuleVideoUnsupported: 'Worker account-stat pricing supports token, request, and image modes',
