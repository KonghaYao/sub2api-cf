export default {
    accounts: {
      ...
      syntheticProbe: {
        open: 'Synthetic probes',
        title: 'Per-model synthetic probes',
        targets: 'Probe targets',
        targetHint: 'Choose an enabled model capability for the selected accounts. Up to 25 targets per run.',
        selected: '{count}/{max} selected',
        noLegalTargets: 'No enabled model capabilities are available for the selected accounts.',
        limitExceeded: 'A run can contain at most {max} unique targets.',
        run: 'Queue probes',
        submitting: 'Queuing...',
        submitFailed: 'Failed to queue synthetic probes.',
        resultSummary: '{queued} accepted, {failed} stale or rejected',
        accepted: 'Accepted',
