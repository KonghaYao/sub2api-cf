export default {
  ...
  payment: {
    ...
    admin: {
      ...
      deductBalance: 'Revoke balance or entitlement',
      deductBalanceHint: 'Automatic clawback is deferred; checked refunds fail closed',
      userBalance: 'User Balance',
      orderAmount: 'Order Amount',
      insufficientBalance: 'Insufficient balance — will deduct to $0',
      noDeduction: 'Courtesy refund: balance and subscription entitlement remain usable',
