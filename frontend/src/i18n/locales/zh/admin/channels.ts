export default {
    ...
    channels: {
      ...
      form: {
        ...
        accountStatsRuleScopeRequired: '每条账号统计定价规则至少选择一个分组或账号',
        accountStatsRulePricingRequired: '每条账号统计定价规则至少需要一项包含模型的价格',
        accountStatsRuleVideoUnsupported: 'Worker 账号统计定价仅支持 Token、按请求和图片模式',
