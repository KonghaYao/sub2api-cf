export default {
    ...
    invitation: {
      ...
      never: '永不过期',
      allStatuses: '全部状态',
      searchPlaceholder: '搜索邀请码或备注...',
      autoGenerate: '留空则自动生成',
      copyLink: '复制注册链接',
      records: '使用记录',
      usageRecords: '邀请码使用记录',
      noUsages: '暂无使用记录',
      empty: '没有找到邀请码',
      deleteConfirm: '确定删除这个未使用的邀请码吗？此操作无法撤销。',
      created: '邀请码创建成功',
      updated: '邀请码更新成功',
      deleted: '邀请码删除成功',
      linkCopied: '注册链接已复制',
      failedToLoad: '加载邀请码失败',
      failedToCreate: '创建邀请码失败',
      failedToUpdate: '更新邀请码失败',
      failedToDelete: '删除邀请码失败',
      failedToLoadUsages: '加载邀请码使用记录失败',
      failedToCopy: '复制注册链接失败'
    },
