export default {
    accounts: {
      ...
      syntheticProbe: {
        ...
        title: '按模型执行合成探针',
        targets: '探针目标',
        targetHint: '从已选账号中选择已启用的模型能力；每次最多提交 25 个目标。',
        selected: '已选 {count}/{max}',
        noLegalTargets: '所选账号没有可用的已启用模型能力。',
        limitExceeded: '单次最多提交 {max} 个不重复目标。',
        run: '提交探针',
        submitting: '提交中...',
        submitFailed: '提交合成探针失败。',
        resultSummary: '已接受 {queued} 个，过期或拒绝 {failed} 个',
        accepted: '已接受',
        stale: '配置过期 / 已拒绝',
        history: '探针历史',
        loading: '加载中...',
        retry: '重试',
        historyFailed: '加载探针历史失败。',
        noHistory: '暂无探针历史。',
        loadMore: '加载更多',
        modelCapability: '模型 / 能力',
        status: '状态',
        errorClass: '错误分类',
        latency: '延迟',
        createdAt: '创建时间',
