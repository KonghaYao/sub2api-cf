export default {
  ...
  keys: {
    ...
    customKeyPlaceholder: '输入自定义密钥（24–128个字符）',
    customKeyHint: '仅允许字母、数字、下划线和连字符，长度24–128，且至少包含8种不同字符。',
    customKeyTooShort: '自定义密钥至少需要24个字符',
    customKeyTooLong: '自定义密钥最多允许128个字符',
    customKeyLowEntropy: '自定义密钥至少需要包含8种不同字符',
