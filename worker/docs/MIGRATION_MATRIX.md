...
4. **Media and realtime**: v0.21 delivers the batch Images tracer bullet: the frontend-used
   ...
   metadata and private R2 request/result/image objects with scheduled expiry cleanup.
   Remaining media work is data-URL/remote-URL async rehosting, provider-job result reconciliation, and all video,
