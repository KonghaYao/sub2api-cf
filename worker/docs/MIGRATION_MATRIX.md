...
3. **Identity completion**: email verification, password reset, and versioned notification-email
   ...
   sender and deployed delivery E2E. TOTP, recovery codes and privileged-operation step-up are
   implemented; next are OAuth linking, passkeys, and linked identities.
