...
it.each([[false,false,false],[true,false,false],[false,true,false],[true,true,false],[false,true,true],[true,true,true]])('keeps native Anthropic cache usage in client, ledger and dashboard (stream=%s, priced=%s, freeInterval=%s)',async (stream,priced,freeInterval)=>{
